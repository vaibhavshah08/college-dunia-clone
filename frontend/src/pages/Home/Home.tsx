      ...
      <Box>
        ...
        >
          ...
          <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
            ...
            >
              Discover thousands of colleges, compare them side by side, and
              make informed decisions about your education. Apply for loans and
              manage your documents all in one place.
            </Typography>
            <Box
              sx={{
                mt: 4,
